---
title: "Truth vs. Helpfulness: A Logic Puzzle Trap for AI"
date: 2026-03-01
description: "A benchmark test using a deliberately unsolvable logic puzzle reveals how SLMs and LLMs handle contradiction — and whether they prioritize truth or helpfulness."
tags: ["AI", "LLM", "SLM", "reasoning", "benchmark", "logic"]
---

*first published on dev.to - thanks to that community for their interest and contributions*

This article covers a benchmark test I ran using a deliberately unsolvable logic puzzle, comparing how a local SLM and several online LLMs handle a built-in contradiction.
...
## The Puzzle: The Midnight Gathering
...
1. The guest in the Library has the Telescope.
2. Alice is in the Terrace.
3. The guest with the Journal is in the Gallery.
4. Charlie is in the Kitchen.
5. Bob has the Compass.
6. The Lantern is not in the Library or the Kitchen.
7. David is in the Gallery.
8. The Key is owned by the person in the Balcony.
9. Eve is not in the Library.
...
## Analysis: What the Puzzle Tests
...
It occurred to me that if I looked at it in human terms, AI models could be said to fall into two categories:
...
I challenged Antigravity on its role as test creator, proctor, judge, and jury — particularly given that it was running on Gemini Flash, the same underlying model used in the online Gemini LLM being tested. Why did the results differ between them?
